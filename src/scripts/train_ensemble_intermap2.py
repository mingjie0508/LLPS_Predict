##########
# Script for training sequence-structure intermap model (ESM2 & SaProt & FINCHES)
#
# Usage:
# cd LLPS_Predict
# python -m src.scripts.train_ensemble_intermap2 [--config c] [--data_path d] 
#   [--batch_size n] [--dropout p] [--epochs e] [--lr l] [--weight_decay wd]
#
...
from src.loaders.dataset_triplet import LLPSDatasetTriplet
from src.models.model_ensemble import EnsembleIntermapClassifier2
...
SQN_COLUMN3 = config['sqn_column3']
...
# Dataloader
seq3_transform = force_field_transform_factory(img_size=IMG_SIZE)
dataset_train = LLPSDatasetTriplet(
    TRAIN_DATA_PATH, SQN_COLUMN1, SQN_COLUMN2, SQN_COLUMN3, LABEL_COLUMN,
    seq3_transform=seq3_transform
)
...
# Training
# model
classifier = EnsembleIntermapClassifier2(
