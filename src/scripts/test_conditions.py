##########
# Script for testing ESM2 + MLP for predicting LLPS under specific conditions, 
#
# Usage: 
# cd LLPS_Predict
# python -m src.scripts.test_conditions [--config c] [--data_path d] [--score_path s]
...
from src.loaders.dataset_condition import LLPSConditionsDataset
from src.models.model_condition import EnsembleConditionsClassifier
# data transformation
from src.utils.experimental_condition import experimental_condition_transform_factory
# evaluation metrics
from src.utils.metrics import classification_metrics
from src.utils.trainer import save_partial_model
# config parameters
import yaml
import argparse
# predict loop
...
RANGE_LOW_COLUMN = config['range_low_column']
RANGE_HIGH_COLUMN = config['range_high_column']
...
dataset_test = LLPSConditionsDataset(
    TEST_DATA_PATH, 
    sqn_column=SQN_COLUMN, 
    cond_columns=CONDITION_COLUMNS, 
...
save_partial_model(classifier, CHECKPOINT_PATH)
raise
