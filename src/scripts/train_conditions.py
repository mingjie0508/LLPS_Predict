##########
# Script for training ESM2 + MLP for predicting LLPS under specific conditions, 
#
# Usage: 
# cd LLPS_Predict
# python -m src.scripts.train_conditions [--config c] [--data_path d] [--batch_size n] 
...
print('Sequence embedding model:', SQN_EMBED_MODEL)
print('Seed:', SEED)
...
dataset_train = LLPSConditionsDataset(
    TRAIN_DATA_PATH, 
