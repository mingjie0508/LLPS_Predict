##########
# Script for testing sequence-structure intermap model (ESM2 & SaProt & FINCHES)
#
# Usage: 
# cd LLPS_Predict
...
dataset_test = LLPSDatasetTriplet(
    TEST_DATA_PATH, SQN_COLUMN1, SQN_COLUMN2, SQN_COLUMN3, LABEL_COLUMN,
