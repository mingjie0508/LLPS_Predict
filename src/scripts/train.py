##########
# Script for training single-modality model, 
# e.g., sequence model (ESM2) alone or structure language model (SaProt) alone
# for predicting LLPS propensity
#
# Usage:
# cd LLPS_Predict
# python -m src.scripts.train [--config c] [--data_path d] [--batch_size n] 
...
dataset_train = LLPSDataset(
    TRAIN_DATA_PATH, sqn_column=SQN_COLUMN, label_column=LABEL_COLUMN
)
